...
@section('content')
   <div class="py-8 pr-4">
        <div class="flex flex-col   h-[10vh] gap-6 mb-16">
            ...
            <a class=' mx-5' href="{{route('demandes.trash')}}">trash</a>
        </div>
        <div>
                            ...
                            <td>
                                <div class="flex justify-center">
                                    <div class="flex gap-1">
                                        <a href="{{ route('demandes.show', $demande->id) }}" class="h-fit p-2 bg-green-500 hover:bg-green-700 text-white rounded-md">show</a>
                                        <form class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md" method="POST" action="{{ route('demandes.destroy', $demande->id) }}" onsubmit="return confirm('confirmez-vous la supprission de la demande?');">
                                        @csrf
                                        @method('DELETE')
